...
- Focar nas principais características destacadas na etapa anterior.
...
- Apresentação da distribuição das características da população
...
- Apresentação da taxa de participação
